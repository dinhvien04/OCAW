...
if (isset($_GET["id"])) {
    ...
    echo'<img src="/OCAW/images/'.$row['HinhURL'].'"></td><td style="float: right;">';
    ...
    echo '<br/><br/><br/><a class="submit3" href="/OCAW/giohang/index.php?mod=them&item='.$row['MaSanPham'].'">Mua hàng</a>';
    echo'</p>';
    echo'</td></tr></table>';
    echo'</div>';
    ...
    while($show = mysqli_fetch_array($tvspcl))
    {
        ...
        $hinh = $show['HinhURL'];
        echo'<div class="list2"><a href="/OCAW/SanPham/index.php?mod=sanpham&id='.$id.'">
        <img src="/OCAW/images/'.$hinh.'" width="215px" height="200px"></a>';
        echo '<a id="tensp" href="/OCAW/SanPham/index.php?mod=sanpham&id='.$id.'"><p>'.$name.'</p></a>';
