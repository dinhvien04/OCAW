...
<?php
 if ($ok != 2)
  {
  echo '<div class="list">Không có sản phẩm nào. <a href="OCAW/index.php">Quay lại cửa hàng</a> để tiếp tục mua sắm.</div></div>';
...
echo '<td width="5%" style="border:1px solid #ebebeb; text-align: center;">
        <form action="../giohang/index.php?mod=xoa&id='.$row['MaSanPham'].'" method="POST">
  ...
  echo '<form action="/OCAW/giohang/index.php?mod=thanhtoan" method="POST">';

  echo'<a class="submit" href="/OCAW/index.php">Tiếp tục mua sắm</a>';

  echo '<input type="submit" name="ThanhToan" value="thanh toán tiền mặt"></div></form>';
  echo '<form method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="/OCAW/giohang/momo_payment.php" style="margin-top: 10px;">';
echo '<input type="hidden" name="tongtien" value="' . $tongtien . '">'; // Sửa lỗi cú pháp PHP
echo '<input type="submit" name="ThanhToanMomo" value="Thanh toán qua Momo" style="
...
echo '</form>';
  ...
  echo '<form method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="/OCAW/giohang/momo_atm.php" style="margin: 0;">
        <input type="hidden" name="tongtien" value="' . $tongtien . '">
        <input type="submit" name="ThanhToanMomoATM" value="Thanh toán qua MoMo ATM" style="
            padding: 10px 20px;
  ...
  echo '<form action="/OCAW/giohang/index.php?mod=huydonHang" method="POST" style="margin-top: 10px;">';
  echo '<input type="submit" name="huydonHang" value="Hủy hết đơn hàng" style="background-color: red; color: white; padding: 10px; border: none; cursor: pointer;">';
  echo '</form>';
...
//     <form action="/OCAW/giohang/index.php?mod=thanhtoan" method="POST" style="margin: 0;">
//         <input type="submit" name="ThanhToan" value="Thực hiện thanh toán" style="
//             padding: 10px 20px;
...
//     <form method="POST"  action="/OCAW/giohang/momo_payment.php" style="margin: 0;">
//         <input type="hidden" name="tongtien" value="' . $tongtien . '">
//         <input type="submit" name="ThanhToanMomo" value="Thanh toán qua MoMo" style="
//             padding: 10px 20px;
//             background-color: purple;
//             color: white;
//             border: none;
...
//     </form>
    ...
    // <form method="POST" action="/OCAW/giohang/momo_atm.php" style="margin: 0;">
    //     <input type="hidden" name="tongtien" value="' . $tongtien . '">
    //     <input type="submit" name="ThanhToanMomoATM" value="Thanh toán qua MoMo ATM" style="
    //         padding: 10px 20px;
    //         background-color: #FF9900;
...
//     <form action="/OCAW/giohang/index.php?mod=huydonHang" method="POST" style="margin: 0;">
//         <input type="submit" name="huydonHang" value="Hủy đơn hàng" style="
//             padding: 10px 20px;
//             background-color: red;
//             color: white;
//             border: none;
