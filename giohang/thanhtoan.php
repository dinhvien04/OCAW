...
if (isset($_POST['ThanhToan'])) {
    ...
    if ($them2) {
        echo '<div class="list">Đặt hàng thành công bằng tiền mặt!</div>';
        echo '<div class="list">Mã đơn hàng của bạn: ' . $maddh . '</div>';
        echo '<div class="list"><a href="/OCAW/donhang/index.php?mod=chitiet&id=' . $maddh . '">Xem chi tiết đơn hàng</a></div>';
        unset($_SESSION['cart']);
    }
}
