...
<body>
    <div class="header">
        <div class="topbar">
            <div class="center">
                ...
                <ul class="listtopbar">
                    ...
                    if(isset($_SESSION['username']) && $_SESSION['username']) {
                        if ($row['Quyen'] == 1) {
                            echo'<li id="adm"><a href="/OCAW/AdminPanel">Admin Panel</a></li>';
                        }    
                        echo'
        ...
        <div class="cenbar">
            <div class="center">
                <a class="logo" href="/OCAW/index.php"><img src="/OCAW/cc.png"></a>
                <div class="search">
                ...
                <div class="lienlac">
                    <div id="phone">
                    <a href="/OCAW/giohang/index.php" style="text-decoration: none; color: #fff;">
                    ...
                    <?php
                        if(isset($_SESSION['cart'])) {
                            ...
                            echo'<a href="/OCAW/giohang/index.php" style="text-decoration: none;">
                    ...
                    ?>
                        <a href="/OCAW/giohang/index.php" style="text-decoration: none;"><span id="dd"><font color="#ffdada">Giỏ hàng</font> </span>
                        </a>
                    </div> 
                </div> 
            </div>
                ...
                <li id="danhmucsp">
                    ...
                    <ul class="dssp">
                        ...
                        while($row = mysqli_fetch_array($loaisp)) {                           
                            ...
                            echo '<li id="n">
                            <a href="/OCAW/SanPham/index.php?mod=dssp&id='.$id.'">
                            <i class="far fa-star"></i>&nbsp;&nbsp;&nbsp;'.$row['TenLoaiSanPham'].'</a></li>';
                        }
                        ?>
                    </ul>
                </li>
                    <li id="m"><a href="/OCAW/index.php">TRANG CHỦ</a></li>
                    <li id="m"><a href="/OCAW/khienMai.php">KHUYẾN MÃI</a></li id="m">
                    <li id="m"><a href="/OCAW/lienHe.php">LIÊN HỆ</a></li id="m">
                </ul>
            </div>
        </div>
