...
if(isset($_GET['id'])) {
    ...
    <div class="center">
        <div id="ban">
            <a id="ba" href="/OCAW/index.php">Trang chủ</a> > S
    ...
    echo ' <a class="submit3" href="../qlyDonhang/in.php">In hóa đơn</a>';
    echo ' <a class="submit4" href="../qlyDonhang/index.php">Quay lại</a>';
    echo '</div><div class="list">';
    echo 'Các sản phẩm: ';
    $stt = 1;
