...
if (isset($_POST['themHSX'])) {
    ...
    if (mysqli_query($connection, $sql)) {
        echo "<div class='list'>Thêm thương hiệu thành công. <a href='/OCAW/qlyHangSX/index.php?mod=panel'>Quay lại</a></div>";
        exit;
    } else {
        echo "Error: " . $sql . "<br>" . mysqli_error($connect);
        echo'<a href="/OCAW/qlyHangSX/index.php?mod=panel">Quay lại</a>';
        exit;
    }
}
...
<div id="vien">
    <div class="center">
        <div id="ban">
            ...
            <a id="ba" href="/OCAW/qlyHangSX/index.php?mod=panel">Quản lý thương hiệu</a> > 
            <font color="#008744">Thêm thương hiệu</font>
        </div>
    </div>
</div>
<div class="list">
    <form action='/OCAW/qlyHangSX/index.php?mod=add' method='POST' enctype="multipart/form-data">
        ...
        <a href='/OCAW/qlyHangSX/index.php?mod=panel'>Quay lại</a></p>
    </form>
</div>