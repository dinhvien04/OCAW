...
if (isset($_POST['themloaisp'])) {
    ...
    if (mysqli_query($connection, $sql)) {
        echo "<div class='list'>Thêm loại sản phẩm thành công. <a href='/OCAW/qlyLoaiSP/index.php?mod=panel'>Quay lại</a></div>";
        exit;
    } else {
        echo "Error: " . $sql . "<br>" . mysqli_error($connect);
        echo'<a href="/OCAW/qlyLoaiSP/index.php?mod=panel">Quay lại</a>';
        exit;
    }
}
...
<div id="vien">
    <div class="center">
        <div id="ban">
            ...
            <a id="ba" href="/OCAW/qlyLoaiSP/index.php?mod=panel">Quản lý loại sản phẩm</a> > 
            <font color="#008744">Thêm loại sản phẩm</font>
        </div>
    </div>
</div>
<div class="list">
    <form action='/OCAW/qlyLoaiSP/index.php?mod=add' method='POST' enctype="multipart/form-data">
        ...
        <a href='/OCAW/qlyLoaiSP/index.php?mod=panel'>Quay lại</a></p>
    </form>
</div>