...
if (isset($_GET["id"])) {
    ...
    if (mysqli_query($connection, $sql)) {
        echo "<div class='list'>Sửa tên loại sản phẩm thành công. <a href='/OCAW/qlyLoaiSP/index.php?mod=panel'>Quay lại</a></div>";
        exit;
    } else {
...
<div id="vien">
    <div class="center">
        <div id="ban">
            ...
            <a id="ba" href="/OCAW/qlySanPham/index.php?mod=panel">Quản lý loại sản phẩm</a> > 
...
<div class="list">
<?php
echo '<form action="/OCAW/qlyLoaiSP/index.php?mod=update&id='.$id.'" method="POST" >';
?>
