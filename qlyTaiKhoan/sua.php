...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['capnhatthongtin'])) {
        ...
        if (mysqli_query($connection, $sql)) {
            echo '<div class="list">Cập nhật thông tin cá nhân thành công. <a href="/OCAW/qlyTaiKhoan/index.php?&id='.$id.'">Quay lại</a></div>';
            exit;
        } else {
            echo '<div class="list">Đã có lỗi xảy ra. <a href="/OCAW/qlyTaiKhoan/index.php?&id='.$id.'">Quay lại</a></div>';
            exit;
    }
    }
